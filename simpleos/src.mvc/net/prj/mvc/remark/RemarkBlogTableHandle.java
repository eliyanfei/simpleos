 ...
 */
public class RemarkBlogTableHandle extends AbstractPagerHandle {
	...
	public IDataObjectQuery<?> createDataObjectQuery(ComponentParameter compParameter) {
		...
		if (account == null)
			return null;
		final IQueryEntitySet<BlogRemark> qs = BlogUtils.getTableEntityManager(BlogRemark.class).query(
				new ExpressionValue("1=1  order by createdate desc"), BlogRemark.class);
		return qs;
	}
}
