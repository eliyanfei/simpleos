 ...
 */
public class PageEventAdapter implements ServletContextAttributeListener, ServletContextListener,
		HttpSessionListener, HttpSessionAttributeListener, ServletRequestListener {
	private static final String ATTR_NAME = PageEventAdapter.class.getName();

	public static PageEventAdapter getInstance(final ServletContext servletContext) {
		return (PageEventAdapter) servletContext.getAttribute(PageEventAdapter.ATTR_NAME);
	}
	...
	public void contextInitialized(final ServletContextEvent servletContextEvent) {
		servletContextEvent.getServletContext().setAttribute(PageEventAdapter.ATTR_NAME, this);
