	...
	public static String rssRender(final PageRequestResponse requestResponse) {
		...
		try {
			...
			if (channel == null) {
				...
				int j = 0;
				sb.append("<div class=\"list_layout\">");
				while (j++ < l) {
					final RssChannelItem item = it.next();
					sb.append("<div class=\"rrow\">");
					sb.append("<div class=\"ti numDot\">");
					...
					sb.append("</span>");
					sb.append("<span class=\"n " + (j <= 3 ? "" : "n2") + "\">" + j + "</span>");
					sb.append("<a target=\"_blank\" class='nt' href=\"").append(item.getLink()).append("\">");
