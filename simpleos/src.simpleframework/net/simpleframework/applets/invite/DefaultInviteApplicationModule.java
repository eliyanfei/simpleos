 ...
 */
public class DefaultInviteApplicationModule extends AbstractWebApplicationModule implements
		IInviteApplicationModule {
	...
	public String getApplicationText() {
		return StringUtils.text(super.getApplicationText(),
				LocaleI18n.getMessage("DefaultInviteApplicationModule.0"));
	}
}
