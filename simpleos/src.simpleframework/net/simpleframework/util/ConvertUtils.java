...
public abstract class ConvertUtils {
	...
	public static final String toString(final Object obj) {
		if (obj == null) {
			...
			return StringUtils.join((Object[]) obj, IConstants.NEWLINE);
		} else {
	...
	public static final String toDateString(final Date date, final String pattern, final String defValue) {
		final SimpleDateFormat sdf = new SimpleDateFormat(pattern);
		return date == null ? defValue : sdf.format(date);
	}
