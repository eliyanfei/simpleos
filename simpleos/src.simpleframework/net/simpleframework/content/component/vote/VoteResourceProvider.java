 ...
 */
public class VoteResourceProvider extends AbstractComponentResourceProvider {

	public VoteResourceProvider(final IComponentRegistry componentRegistry) {
	...
	private final static String[] JAVASCRIPT_PATH = new String[] { "/js/vote.js" };
	...
	public String[] getCssPath(final PageRequestResponse requestResponse,
			final Collection<AbstractComponentBean> componentBeans) {
		return new String[] { getCssSkin(requestResponse, "vote.css") };
	}
}
