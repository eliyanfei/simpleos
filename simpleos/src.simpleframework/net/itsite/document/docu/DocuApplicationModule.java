...
public class DocuApplicationModule extends AItSiteAppclicationModule implements IDocuApplicationModule {
	...
	public static final Table docu_documentshare = new Table("it_document");
	public static final Table docu_catalog = new Table("it_document_catalog");
	public static final Table docu_remark = new Table("it_document_remark");
	public static final Table docu_user = new Table("it_document_user");
	public static final Table docu_log = new Table("it_document_log");
