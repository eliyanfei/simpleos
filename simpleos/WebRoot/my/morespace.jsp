...
<%@page import="net.prj.manager.template.PrjTemplateBean"%>
<%@page import="net.prj.manager.template.PrjTemplateUtils"%>
...
<%
	...
	final PrjTemplateBean templateBean = PrjTemplateUtils
			.getTemplateBean();
	final Object userId = ItSiteUtil.getLoginUser(requestResponse)
			.getId();
...
<jsp:include page="<%=templateUrl %>" flush="true">
	<jsp:param value="/my/morespace_c.jsp" name="center" />
</jsp:include>