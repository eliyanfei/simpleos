...
<%
	...
	final DocuBean docuBean = DocuUtils.applicationModule.getBean(
			DocuBean.class, docuId);
	final PageRequestResponse requestResponse = new PageRequestResponse(
			request, response);
	final String upload = WebUtils.addParameters(
			DocuUtils.applicationModule.getViewUrl1(requestResponse, 4,
					0, 0), "id=myUpload");
%>
<div>
		...
		<table width="100%'">
			<tbody>
				...
				<tr>
					...
					<td><textarea id="docu_content" name="docu_content" rows="5"
				...
				<tr>
					...
					<td>
						<div id="td_docu_catalog" style="width: 90%"></div> <input
...
<div align="center">
	...
	%>
	<div style="color: red;">#(Docu.add.7)</div>
	<input type="button" id="uploadDocuBtn" class="button2"
