...
<%
	...
	final String appUrl = BlogUtils.applicationModule.getApplicationUrl(requestResponse);
	final IAccount login = AccountSession.getLogin(requestResponse.getSession());
	final String myblogUrl = login == null ? LoginUtils.getLocationPath() : BlogUtils.applicationModule.getBlogUrl(requestResponse,
			login.user());
%>
<div class="simple_toolbar2 clear_float">
	...
	<div style="float: left;">
		<div style="margin-bottom: 4px;">
			...
			<%
				if (IWebApplicationModule.Utils.isManager(requestResponse, BlogUtils.applicationModule)) {
			%>
			<a class="a2" style="margin-left: 10px;"
				onclick="$Actions['blogManagerToolsWindow']();">#(manager_tools.0)</a>
			<%
				}
			%>
		</div>
