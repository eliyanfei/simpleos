...
<%@ page import="java.util.List"%><%@page
	...
	import="net.simpleos.mvc.remark.RemarkUtils"%><%@page
	import="net.simpleos.module.docu.DocuRemark"%><%@page
...
<div class="listpager" id="_tablepaper">
	<%
		...
		int i = 1;
		for (Object o : data) {
			final DocuRemark remark = (DocuRemark) o;
			final DocuBean docuBean = DocuUtils.applicationModule.getBean(DocuBean.class, remark.getDocumentId());
			if (docuBean == null) {
				continue;
			}
	%>
			...
			<tr>
				<td valign="top" width="100%">
					<table style="width: 100%">
						<tr>
							<td class="title">
								<%=DocuUtils.wrapOpenLink(componentParameter, docuBean)%>
							</td>
						</tr>
						<tr>
							<td class="wrapWord">
