 ...
 * 2013-12-3上午11:43:30
 */
public class PrjMenuBean extends Catalog implements IEntityBeanAware {
	...
	private String url;
	public List<PrjMenuBean> childs = new ArrayList<PrjMenuBean>();
	...
	public ITreeBeanAware parent() {
		return PrjMenuUtils.appModule.getBean(PrjMenuBean.class, getParentId());
	}
