...
public abstract class AbstractCatalog extends Catalog implements IEntityBeanAware {
	...
	public static class Utils {
		...
		public static String getJoinCatalog(final Object catalogId, final IItSiteApplicationModule iItSiteApplicationModule, final Class<?> className) {
			final StringBuffer buf = new StringBuffer();
		...
		public static void getJoinCatalog(final AbstractCatalog catalog, final StringBuffer buf,
				final IItSiteApplicationModule iItSiteApplicationModule, final Class<?> className) {
