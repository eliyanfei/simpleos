 ...
 */
public abstract class ASimpleosAppclicationModule extends AbstractContentApplicationModule implements ISimpleosApplicationModule {
	...
	protected String buildAttentionHTML(final PageRequestResponse requestResponse, final ICommonBeanAware commonBean, final String text,
		...
		if (SimpleosUtil.isLogin(requestResponse)) {
			...
			buf.append(SimpleosUtil.isAttention(requestResponse, getEFunctionModule(), commonBean.getId(), "取消" + text, text));
			...
			if (editId != null && SimpleosUtil.isManageOrSelf(requestResponse, this, commonBean.getUserId())) {
