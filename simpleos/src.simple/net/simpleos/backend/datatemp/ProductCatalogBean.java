 ...
 * 2013-12-3上午11:43:30
 */
public class ProductCatalogBean extends Catalog implements IEntityBeanAware {
	public static final short MARK_SELECTED = 0;

	public static final short MARK_UNSELECTED = 1;

	private boolean buildIn = false;
	public List<ProductCatalogBean> childs = new ArrayList<ProductCatalogBean>();
	...
	public ITreeBeanAware parent() {
		return DataTempUtils.appModule.getBean(ProductCatalogBean.class, getParentId());
	}
