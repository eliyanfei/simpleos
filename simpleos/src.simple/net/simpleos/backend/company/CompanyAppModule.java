 ...
 * 2013-12-3下午12:29:55
 */
public class CompanyAppModule extends AItSiteAppclicationModule implements ICompanyAppModule {
	...
	public void init(final IInitializer initializer) {
		...
		doInit(CompanyUtils.class, deployName);
		CompanyUtils.appModule = this;
	}
