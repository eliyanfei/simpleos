 ...
 */
public class LinksTableHandle extends AbstractDbTablePagerHandle {
	@Override
	...
	public IDataObjectQuery<?> createDataObjectQuery(final ComponentParameter compParameter) {
		return LinksUtils.appModule.queryBean("1=1 order by oorder", new Object[] {}, LinksBean.class);
	}
	...
	public AbstractTablePagerData createTablePagerData(final ComponentParameter compParameter) {
		return new AbstractTablePagerData(compParameter) {
			...
			protected Map<Object, Object> getRowData(Object dataObject) {
				LinksBean linksBean = (LinksBean) dataObject;
