 ...
 */
public class JobSelectResourceProvider extends DictionaryResourceProvider {

	public JobSelectResourceProvider(final IComponentRegistry componentRegistry) {
	...
	public String[] getCssPath(final PageRequestResponse requestResponse,
		...
		return new String[] { getCssSkin(requestResponse, "job_select.css") };
	}
}
