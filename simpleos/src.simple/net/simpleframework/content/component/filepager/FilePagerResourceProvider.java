 ...
 */
public class FilePagerResourceProvider extends TablePagerResourceProvider {

	public FilePagerResourceProvider(final IComponentRegistry componentRegistry) {
	...
	public String[] getCssPath(final PageRequestResponse requestResponse,
		...
		return new String[] { getCssSkin(requestResponse, "filepager.css") };
	}

	private final static String[] JAVASCRIPT_PATH = new String[] { "/js/filepager.js" };
