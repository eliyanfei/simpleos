		...
		return jsonForward(compParameter, new JsonCallback() {
			...
			public void doAction(final Map<String, Object> json) {
				if ((Boolean) nComponentParameter.getBeanProperty("showValidateCode")
						&& !DefaultValidateCodeHandle.isValidateCode(compParameter.request, "textRemarkHtmlEditorValidateCode")) {
					...
					data.put("content1", compParameter.getRequestParameter("textareaRemarkHtmlEditor"));
		...
		return jsonForward(compParameter, new JsonCallback() {
			...
			public void doAction(final Map<String, Object> json) {
				if ((Boolean) nComponentParameter.getBeanProperty("showValidateCode")
					...
					data.put("content1", ContentUtils.doTextContent(compParameter.getRequestParameter("textareaRemarkEditor"), false));
					rHandle.doAdd(nComponentParameter, data);
				}
			}
		});
