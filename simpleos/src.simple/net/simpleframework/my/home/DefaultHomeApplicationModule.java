...
public class DefaultHomeApplicationModule extends AbstractWebApplicationModule implements IHomeApplicationModule {
	...
	public void init(final IInitializer initializer) {
		...
		// 注册layout组件模块
		PortalModuleRegistryFactory.regist(UserPortalModule.class, "my_user", LocaleI18n.getMessage("DefaultHomeApplicationModule.1"), "信息",
				MyHomeUtils.deployPath + "images/user.png", LocaleI18n.getMessage("DefaultHomeApplicationModule.2"));
